	...
	<NuxtLink :to="to" class="w-full" data-aos="fade-up">
		...
		>
			...
			<div class="absolute inset-3 z-10 flex flex-col justify-between">
				...
				<div
					class="surface invert-if-impaired rounded-[2rem] border border-white border-opacity-30 bg-white bg-opacity-25 px-6 py-3 text-center text-white backdrop-blur-md"
				>
					<h4>
						{{ title }}
					</h4>
